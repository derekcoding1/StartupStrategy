...
trash.append("Search the history of over 351 billion web pages on the Internet.         search  Search the Wayback Machine")
trash.append("Is this your domain? Add hosting, email and more.")
